...
/**
 * Tests pour le composant ProgramsComponent
 * Tests for ProgramsComponent
 */
describe('ProgramsComponent', () => {
  ...
  describe('Initialisation du composant', () => {
    ...
    it('should not display create program button (removed)', () => {
      fixture.detectChanges();
      const compiled = fixture.nativeElement;
      expect(compiled.textContent).not.toContain('Créer un programme');
    });
  ...
  describe('Navigation et ajout de programmes', () => {
